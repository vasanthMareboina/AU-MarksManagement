...
<h1 style="padding-right:50%">Sign Up!</h1><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
 ...
 $conn=mysqli_connect("localhost","root","","college");
  ...
  if(mysqli_fetch_assoc(mysqli_query($conn,$sql))){
     die("<br><br><br><br><br><br><br><br><br>userid already exits"); 
  }
  ...
  if(mysqli_fetch_assoc(mysqli_query($conn,$sql))){
     die("<br><br><br><br><br><br><br>userid already exits"); 
	 ...
	 echo "$usertype";
      echo "Success";
          ...
          $pswdErr1="passwords not matched";
		  echo "$pswdErr1";
      }
}
